    ...
    <div>
      <Carousel id='portfolio'>
        <Carousel.Item interval={5000}>
          ...
          />
          <div className='flex'>
              <h1><a href='http://strongjaw15.github.io/the-barstool/' target='blank'> The Barstool</a></h1>
              <p><a href='https://github.com/strongjaw15/the-barstool' target='blank'>GitHub</a></p>
        ...
        <Carousel.Item interval={5000}>
          ...
          />
          <div className='flex'>
              <h1><a href='https://smorgasbord.herokuapp.com/' target='blank' > Smorgasbord</a></h1>
              <p><a href='https://github.com/Greg-Trahan/smorgasbord' target='blank'>GitHub</a></p>
        ...
        <Carousel.Item interval={5000}>
          ...
          />
          <div className='flex'>
              <h1><a href='https://danibano.github.io/work-day-scheduler/' target='blank' > Work-Day App</a></h1>
              <p><a href='https://github.com/danibano/work-day-scheduler' target='blank'>GitHub</a></p>
        ...
        <Carousel.Item interval={5000}>
          ...
          />
          <div className='flex'>
              <h1><a href='https://danibano.github.io/coding-quiz/' target='blank' > Coding Quiz</a></h1>
              <p><a href='https://github.com/danibano/coding-quiz' target='blank'>GitHub</a></p>
        ...
        <Carousel.Item interval={5000}>
          ...
          />
          <div className='flex'>
              <h1><a href='https://danibano.github.io/weather-app/' target='blank' > Weather API</a></h1>
              <p><a href='https://github.com/danibano/weather-app' target='blank'>GitHub</a></p>
